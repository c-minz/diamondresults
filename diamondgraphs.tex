...
\pgfdeclaredataformat{drawEvalues}
{}{}{#1, #2}{
\ifdrawEvalues
	...
	\pgfdatapoint
	\pgfkeyssetvalue{/data point/x}{#2}
	\pgfkeyssetvalue{/data point/y}{\yaxismax}
	\pgfdatapoint
\fi
}{}{}
...
% \def\dataname{biconeArr2Vol1Srlsum}
% \def\xaxismin{1}\def\xaxismax{5.99}\def\xaxisticksstep{1}
...
% \def\dataname{biconeArr2Vol1}
% \def\xaxismin{0}\def\xaxismax{2.95}\def\xaxisticksstep{0.2}\def\xaxisticksprecision{1}
% \def\yaxismax{5}\def\yaxisticksstep{0.5}\def\yaxisticksprecision{1}
% \def\pinlen{1ex}
% \def\pinAxpos{0.6}\def\pinBxpos{0.98}\def\pinCxpos{1.6}
...
% \def\theoryparamA{2}\def\theoryparamB{3.8197}\def\theoryparamC{7.6394}
% \def\shapescaling{0.12}
% \pgfmathsetmacro\shapeposA{( \yaxismax^2 - 1 ) / \theoryparamA / \xaxismax}
% \pgfmathsetmacro\shapeposB{( ( \theoryparamB * \xaxismax + 1 )^(1/3) - \yaxismin ) / ( \yaxismax - \yaxismin )}
% \pgfmathsetmacro\shapeposC{( ( \theoryparamC * \xaxismax + 1 )^(1/4) - \yaxismin ) / ( \yaxismax - \yaxismin )}
